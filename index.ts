...
const [photo1Path, photo2Path, outputPdfPath] = process.argv.slice(2);

if (!photo1Path || !photo2Path || !outputPdfPath) {
	console.error(
...
photosToPdf(photo1Path, photo2Path, outputPdfPath).catch((error) => {
